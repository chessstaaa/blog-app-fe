...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-blue-950">Pengaturan Akun</h1>
        ...
        <div className="relative z-10 flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="min-w-[200px] rounded-lg border border-white/20 bg-white/10 p-4 text-center">
            ...
            <p className="mt-2 text-[10px] text-blue-200">
              Bagikan untuk dapat 10.000 Poin!
            </p>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-gray-400">
                  Email tidak dapat diubah karena terhubung dengan login Anda.
                </p>
              </div>
        ...
        <TabsContent value="security">
          <div className="mt-4 rounded-xl border border-blue-100 bg-white p-6 shadow-sm">
            ...
            >
              ...
              <Separator className="my-2 h-[1px] bg-gray-100" />
              ...
              <div className="flex justify-end pt-2">
                ...
                >
                  {isPassSubmitting ? "Memproses..." : "Ganti Password"}
                </Button>
              </div>
            </form>
          </div>
